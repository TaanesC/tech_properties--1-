...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/17" element={<Frame />} />
      <Route path="/16" element={<Frame1 />} />
      <Route path="/15" element={<Frame2 />} />
      <Route path="/14" element={<Frame3 />} />
      <Route path="/13" element={<Frame4 />} />
      <Route path="/12" element={<Frame5 />} />
      <Route path="/11" element={<Frame6 />} />
      <Route path="/10" element={<Frame7 />} />
      <Route path="/9" element={<Frame8 />} />
      <Route path="/8" element={<Frame9 />} />
      <Route path="/7" element={<Frame10 />} />
      <Route path="/6" element={<Frame11 />} />
      <Route path="/5" element={<Frame12 />} />
      <Route path="/4" element={<Frame13 />} />
      <Route path="/3" element={<Frame14 />} />
